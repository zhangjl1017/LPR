...
void learn2HasPlate(float bound = 0.7)
{
	...
	const char * filePath = "D:\\EasyPR\train\\data\\plate_detect_svm\\learn\\HasPlate";
	vector<string> files;
	...
	for (int i = 0; i < boundry; i++)
	{
		...
		{ 
			...
			ss << "D:\\\EasyPR\\train\\data\\plate_detect_svm\\train\\HasPlate\\hasplate_" << i << ".jpg";
			imwrite(ss.str(), img);
		}
	}
	...
	for (int i = boundry; i < size; i++)
	{
		...
		{ 
			stringstream ss(stringstream::in | stringstream::out);
			ss << "D:\\EasyPR\\train\\data\\plate_detect_svm\\test\\HasPlate\\hasplate_" << i << ".jpg";
			imwrite(ss.str(), img);
		}
	}
}
...
void learn2NoPlate(float bound = 0.7)
{
	...
	const char * filePath = "D:\\EasyPR\\train\\data\\plate_detect_svm\\learn\\NoPlate";
	vector<string> files;
	...
	for (int i = 0; i < boundry; i++)
	{
		...
		{ 
			stringstream ss(stringstream::in | stringstream::out);
			ss << "D:\\EasyPR\\train\\data\\plate_detect_svm\\train\\NoPlate\\noplate_" << i << ".jpg";
			imwrite(ss.str(), img);
		}
	}
	...
	for (int i = boundry; i < size; i++)
	{
		...
		{ 
			stringstream ss(stringstream::in | stringstream::out);
			ss << "D:\\EasyPR\\train\\data\\plate_detect_svm\\test\\NoPlate\\noplate_" << i << ".jpg";
			imwrite(ss.str(), img);
		}
	}
}
...
{
	int label = 1;
	const char * filePath = "D:\\EasyPR\\train\\data\\plate_detect_svm\\train\\HasPlate";
	vector<string> files;
...
{
	int label = 0;
	const char * filePath = "D:\\EasyPR\\train\\data\\plate_detect_svm\\train\\NoPlate";
	vector<string> files;
...
{
	int label = 1;
	const char * filePath = "D:\\EasyPR\\train\\data\\plate_detect_svm\\test\\HasPlate";
	vector<string> files;
...
{
	int label = 0;
	const char * filePath = "D:\\EasyPR\\train\\data\\plate_detect_svm\\test\\NoPlate";
	vector<string> files;
